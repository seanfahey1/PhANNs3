import argparse
import sys
from tools import train_custom_model, predict
sys.path.append("..")
from utils.stored_models import store_newly_generated_model, load_stored_model, list_models, remove_model
...
def get_rm_model_args():
    parser = argparse.ArgumentParser(
        description="Delete a pre-stored model."
    )
    parser.add_argument(
        "-n",
        "--model_name",
...
def train():
    ...
    train_custom_model.initial_predict(train_args.model_name, zscore_array, group_arr, class_arr)
